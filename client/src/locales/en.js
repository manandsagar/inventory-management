export default {
  ...
  restocking: {
    ...
    stats: {
      ...
      totalFundedCost: 'Total Funded Cost',
    ...
    empty: 'No items currently need restocking based on demand forecasts',
    submittedOrdersTitle: 'Submitted Orders',
